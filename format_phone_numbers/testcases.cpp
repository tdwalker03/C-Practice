...
TEST(testFormatNums, null_case)
{
    ASSERT_EQ(NULL, formatNums(NULL));
}

TEST(testFormatNums, null_strings)
{
    // Test with a null pointer to a string
    const char *nums[10] = { "(210)3157904", NULL, "1031376904", "(210) 3157904",
                             "7210313704", "210-315-7904", "210 315 7904", "(210) 315-7904",
                             "8888675309", "2103157904" };
    ASSERT_EQ(NULL, formatNums(nums));

    // Test when the first string is null
    const char *nums2[10] = { NULL, "(210)3157904", "1031376904", "210-315-7904", "210 315 7904",
                            "(210) 3157904", "7210313704", "(210) 315-7904",
                             "8888675309", "2103157904" };
